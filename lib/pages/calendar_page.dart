...
import '../models/important_day.dart'; // แม่แบบ (Model) สำหรับโครงสร้างข้อมูล วันสำคัญ
import '../models/event.dart'; // 	แม่แบบ (Model) สำหรับโครงสร้างข้อมูล กิจกรรมของผู้ใช้
import '../repo/event_repository.dart'; // ผู้ดูแลคลังข้อมูล สำหรับการบันทึก, แก้ไข, และดึงข้อมูล กิจกรรม จากฐานข้อมูล
import '../repo/project_repository.dart'; // ผู้ดูแลคลังข้อมูล สำหรับการจัดการข้อมูล กำหนดส่งโปรเจกต์
import '../services/auth_service.dart'; // ผู้เชี่ยวชาญด้านระบบ สำหรับการตรวจสอบสถานะ การเข้าสู่ระบบ (Session)
...
class _CalendarPageState extends State<CalendarPage> {
  ...
  // 📅 ตัวแปรสถานะปฏิทิน (State Variables)
  DateTime _focusedDay = DateTime.now(); //วัน/เดือน ที่ปฏิทินกำลังแสดงอยู่วัน/เวลาปัจจุบัน
  DateTime? _selectedDay; // วันที่ที่ผู้ใช้เลือกในปฏิทิน ( ? หมายความว่าตัวแปรนี้สามารถเป็น null ได้ ) 
  
  List<ImportantDay> allDays = []; // รายการวันสำคัญทั้งหมดจากทุกแหล่งใช้ในการแสดง จุดสี
  List<Event> userEvents = []; // รายการกิจกรรมที่ผู้ใช้สร้างที่เก็บเป็น Event objects เพื่อใช้ในการลบและจัดการ

  // 🔧 อินสแตนซ์ของ Repository และ Service
  final EventRepository _eventRepo = EventRepository(); /// Repository สำหรับจัดการข้อมูลกิจกรรมในฐานข้อมูล SQLite
  final ProjectRepository _projectRepo = ProjectRepository();/// Repository สำหรับจัดการข้อมูลโปรเจกต์ในฐานข้อมูล SQLite
  final AuthService _authService = AuthService(); /// Service สำหรับจัดการการยืนยันตัวตนและการเข้าสู่ระบบ
