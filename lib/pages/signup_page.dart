...
import '../services/auth_service.dart'; // Import บริการ authentication
...
class SignupPage extends StatefulWidget {
  //Stateful Widget มีสถานะหรือข้อมูลที่เปลี่ยนแปลงได้ขณะใช้งาน
  const SignupPage({super.key});
  //SignupPage คือ "พิมพ์เขียว" ส่วน _SignupPageState คือ "โรงงาน" ที่สร้างและจัดการหน้าจอจริง ๆ
  @override
  State<SignupPage> createState() => _SignupPageState();
} //---------------------------------------------------------

class _SignupPageState extends State<SignupPage> {
  //_SignupPageState="ผู้จัดการ"/"สมอง" ที่ดูแลข้อมูลชั่วคราว
  // Controllers (เครื่องมือรับข้อมูล) สำหรับจัดการข้อมูลในช่องกรอก
  ...
  // Service(ผู้สื่อสารกับระบบ) สำหรับจัดการการสมัครสมาชิก
...
//-----------------------------------------------------
  ...
  /// 📝 ฟังก์ชันสมัครสมาชิก
  /// รับข้อมูลจากผู้ใช้และตรวจสอบความถูกต้อง สร้างบัญชีใหม่ผ่าน AuthService
  void _signUp() async {
    ...
    // เปลี่ยนสถานะ _isLoading เป็น true เพื่อแสดงการโหลด setState() จะทำให้ UI อัปเดตใหม่ (ปุ่มจะแสดง loading)
    setState(() {
      _isLoading = true;
    });
  ...
  /// ------------------------------------------------------------------------------
  /// ------------UI Section (ส่วนของ UI) -----------------------
  /// ------------------------------------------------------------------------------
  /// 🎨 สร้าง UI ของหน้าสมัครสมาชิก KU Planner
  /// Widget build() จะถูกเรียกเมื่อต้องการสร้าง UI ใช้ Scaffold เป็นโครงสร้างหลักของหน้า

  /// ประกอบด้วย:
  /// - โลโก้ KU และ PLANER - ช่องกรอกข้อมูล (ชื่อ, อีเมล, รหัสผ่าน, ยืนยันรหัสผ่าน) - ปุ่มสมัครสมาชิก (พร้อม loading indicator) - ปุ่มเข้าสู่ระบบ
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        ...
        child: Padding(
          padding: const EdgeInsets.all( 20.0, ), // ระยะห่างจากขอบทุกด้าน 20 pixels
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10), // ระยะห่าง 10 pixels
              // 🏷️ ข้อความ "PLANER"
              const Text(  "PLANER", // 🏷️ ข้อความ "PLANER"
                style: TextStyle(
