...
import '../repo/user_repository.dart'; // ✅ import UserRepository
...
class _NewProjectPageState extends State<NewProjectPage> {
  ...
  List<User> allUsers = []; // ✅ รายชื่อผู้ใช้จริงจากฐานข้อมูล
  ...
  // ✅ UserRepository สำหรับดึงข้อมูลผู้ใช้ทั้งหมด
  ...
  void initState() {
    super.initState();
    _loadUsers(); // ✅ โหลดรายชื่อผู้ใช้เมื่อเริ่มต้นหน้า
  }
